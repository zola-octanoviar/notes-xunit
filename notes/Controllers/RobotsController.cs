    ...
    public class RobotsController : Controller
    {
        ...
        public async Task SitemapXml()
        {
            ...
            using (var xml = XmlWriter.Create(Response.Body, new XmlWriterSettings { Indent = true }))
            {
                ...
                var posts = await _note.GetPosts(int.MaxValue);
        ...
        public void RsdXml()
        {
            ...
            using (var xml = XmlWriter.Create(Response.Body, new XmlWriterSettings { Indent = true }))
            {
                ...
                xml.WriteElementString("enginename", "notes_1");
                xml.WriteElementString("enginelink", "http://github.com/madskristensen/notes_1/");
        ...
        public async Task Rss(string type)
        {
            ...
            {
                var posts = await _note.GetPosts(10);
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            if (type.Equals("rss", StringComparison.OrdinalIgnoreCase))
            {
                ...
                await rss.WriteGenerator("notes_1");
            ...
            await atom.WriteGenerator("notes_1", "https://github.com/madskristensen/notes_1", "1.0");
